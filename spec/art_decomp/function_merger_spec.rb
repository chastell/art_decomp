...
module ArtDecomp
  describe FunctionMerger do
    describe '.merge' do
      ...
      let(:f1)   { Function.new(PutsSet.new(is: [a, b], os: [anb]))       }
      let(:f2)   { Function.new(PutsSet.new(is: [b, c], os: [buc]))       }
      let(:f3)   { Function.new(PutsSet.new(is: [b, c], os: [nbuc]))      }
      let(:f4)   { Function.new(PutsSet.new(is: [c, b], os: [nbuc]))      }
      let(:f23)  { Function.new(PutsSet.new(is: [b, c], os: [buc, nbuc])) }
