    ...
    describe '.vhdl_for' do
      ...
      it 'returns VHDL for the given decomposed Circuit' do
        ...
        wires = Wires.from_array([
          ...
          [[:circuit, :ins,  ins,     ins[1],     1, 1, 1],
           [f0,       :ins,  f0.ins,  f0.ins[1],  1, 1, 1]],
          [[:circuit, :ins,  ins,     ins[3],     3, 2, 3],
           [r0,       :ins,  r0.ins,  r0.ins[0],  0, 2, 0]],
          [[r0,       :outs, r0.outs, r0.outs[1], 1, 1, 1],
           [f0,       :ins,  f0.ins,  f0.ins[2],  2, 1, 2]],
          [[:circuit, :ins,  ins,     ins[2],     2, 1, 2],
           [f1,       :ins,  f1.ins,  f1.ins[0],  0, 1, 0]],
          [[f0,       :outs, f0.outs, f0.outs[0], 0, 1, 0],
           [f1,       :ins,  f1.ins,  f1.ins[1],  1, 1, 1]],
          [[f0,       :outs, f0.outs, f0.outs[1], 1, 1, 1],
           [f1,       :ins,  f1.ins,  f1.ins[2],  2, 1, 2]],
          [[r0,       :outs, r0.outs, r0.outs[0], 0, 1, 0],
           [f1,       :ins,  f1.ins,  f1.ins[3],  3, 1, 3]],
          [[r1,       :outs, r1.outs, r1.outs[0], 0, 2, 0],
           [:circuit, :outs, outs,    outs[5],    5, 2, 5]],
          [[f1,       :outs, f1.outs, f1.outs[0], 0, 1, 0],
           [r1,       :ins,  r1.ins,  r1.ins[0],  0, 1, 0]],
          [[f1,       :outs, f1.outs, f1.outs[1], 1, 1, 1],
           [r1,       :ins,  r1.ins,  r1.ins[1],  1, 1, 1]],
          [[f1,       :outs, f1.outs, f1.outs[2], 2, 1, 2],
           [:circuit, :outs, outs,    outs[0],    0, 1, 0]],
          [[f1,       :outs, f1.outs, f1.outs[3], 3, 1, 3],
           [:circuit, :outs, outs,    outs[1],    1, 1, 1]],
          [[f1,       :outs, f1.outs, f1.outs[4], 4, 1, 4],
           [:circuit, :outs, outs,    outs[2],    2, 1, 2]],
          [[f1,       :outs, f1.outs, f1.outs[5], 5, 1, 5],
           [:circuit, :outs, outs,    outs[3],    3, 1, 3]],
          [[f1,       :outs, f1.outs, f1.outs[6], 6, 1, 6],
           [:circuit, :outs, outs,    outs[4],    4, 1, 4]],
        ])
