    ...
    describe '.vhdl_for' do
      ...
      it 'returns VHDL for the given decomposed Circuit' do
        ...
        wires = Wires.from_array([
          [[:circuit, :ins,    0, 1], [f0,       :ins,         0, 1]],
          [[:circuit, :ins,    1, 1], [f0,       :ins,         1, 1]],
          [[:circuit, :states, 0, 2], [r0,       :ins,         0, 2]],
          [[r0,       :outs,   1, 1], [f0,       :ins,         2, 1]],
          [[:circuit, :ins,    2, 1], [f1,       :ins,         0, 1]],
          [[f0,       :outs,   0, 1], [f1,       :ins,         1, 1]],
          [[f0,       :outs,   1, 1], [f1,       :ins,         2, 1]],
          [[r0,       :outs,   0, 1], [f1,       :ins,         3, 1]],
          [[r1,       :outs,   0, 2], [:circuit, :next_states, 0, 2]],
          [[f1,       :outs,   0, 1], [r1,       :ins,         0, 1]],
          [[f1,       :outs,   1, 1], [r1,       :ins,         1, 1]],
          [[f1,       :outs,   2, 1], [:circuit, :outs,        0, 1]],
          [[f1,       :outs,   3, 1], [:circuit, :outs,        1, 1]],
          [[f1,       :outs,   4, 1], [:circuit, :outs,        2, 1]],
          [[f1,       :outs,   5, 1], [:circuit, :outs,        3, 1]],
          [[f1,       :outs,   6, 1], [:circuit, :outs,        4, 1]],
        ])
