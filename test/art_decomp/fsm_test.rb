...
module ArtDecomp
  describe FSM do
    ...
    describe '#adm_size' do
      it 'returns the admissible heuristic size of the FSM' do
    ...
    describe '#inpsect' do
      it 'returns a readable representation' do
        ...
        empty.update(functions: [f1, f2]).inspect
          .must_equal 'ArtDecomp::FSM([ArtDecomp::Arch[2,1], ' \
                      'ArtDecomp::Arch[4,3]])'
      end
    end
    ...
    describe '#max_size' do
      it 'returns the maximum size of the FSM' do
    ...
    describe '#min_size' do
      it 'returns the smallest possible size of the FSM' do
